    ...
    while True:
        ...
        try:
            ...
            if mod_input == 1:
                                                            ...
                                                            for PtnsSymps in DTLS:
                                                                ...
                                                                if Infodtls[0] == 0:
                                                                    ...
                                                                    if Doc_Av[0] == 0:
                                                                        ...
                                                                        SLOT_list = []
                                                                        DT_list = []
                                                                        head = ["DOCID", "DOCTORNAME", "DEPARTMENT","DATE", "STARTTIME", "SLOT"]
                                                                        mydata = []
                                                                        for Fetch_Doc in DocDTLS:
                                                                            ...
                                                                            ENDTIME = Fetch_Doc[6]
                                                                            SLOT = Fetch_Doc[7]
                                                                            temp_list = [DOCID, DOCTORNAME, DEPARTMENT,DATE, STARTTIME, SLOT]
                                                                            mydata.append(temp_list)
                                                                        ...
                                                                        while n == 1:
                                                                            try:
                                                                                ...
                                                                                if Enter_Slot in SLOT_list:
                                                                                    cursor.execute(
                                                                                        "select DOC_ID,DATE,TIME_SLOT_START from DOCTOR_CALENDAR where DOC_ID = ? AND DATE = ? AND SLOT = ? ",
                ...
                while True:
                    try:
                        print("Doctors Code goes here")
                        break
                    except:
                        print("Merge your code")
                        print("")
                        Return_Menu = input("Press ENTER KEY to go back to Main Menu")
                        break
